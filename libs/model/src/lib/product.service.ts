...
export class ProductService extends BaseEntityServiceImplementation<
  ProductModel,
...
> {
  ...
  protected async doSave(
    ...
    entity.buyingAccount = Promise.resolve(
      args.buyingAccount
        ? args.buyingAccount
        : await accountService.getAccountByCode(args.buyingAccountCode)
    );
    entity.sellingAccount = Promise.resolve(
      args.sellingAccount
        ? args.sellingAccount
        : await accountService.getAccountByCode(args.sellingAccountCode)
    );
    entity.sku = args.sku;
    return entity;
  }
